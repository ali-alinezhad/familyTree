    ...
    <main class="hoc container clear">
        ...
        <section id="introblocks">
            <ul class="nospace group btmspace-80">
                ...
                <li class="one_third">
                    <figure><a class="imgover" href="#"><img src="{{ $homepage->logo }}" alt="{{ asset('images/logo/logo.jpg') }}"></a>
                        <figcaption>
        ...
        <section class="group" id="news">
            <div class="one_half first"><img class="inspace-15 borderedbox" src="{{ asset('images/logo/logo.jpg') }}" alt=""></div>
            <div class="one_half">
...
<div class="wrapper row5">
    <div id="copyright" class="hoc clear">
        ...
        <p class="fl_right">Developed by <a target="_blank" href="https://www.os-templates.com/" title="Free Website Templates">Ali Alinezhad</a></p>
    </div>
</div>
