...
@section('content')
    <div class="container-fluid">
        <div class="px-lg-5">
            @if($user->role < 2)
                <div class="row pb-5">
                    <button class="btn btn-outline-primary" data-toggle="modal" data-target="#uploadMusic">
                        {{ __('translations.upload_music') }} <i class="cil-plus"></i>
                    </button>
                </div>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                {{ __('translations.upload_music') }}
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <div class="modal-body">
                                {{ Form::open(['route'=>['music.upload',$locale], 'method' => 'put','enctype'=>"multipart/form-data"]) }}
                                <div>
                        ...
                        <div class="bg-white rounded shadow-sm">
                            ...
                            <div class="p-4">
                                <div
                                    ...
                                    <a href="{{ route('music.details',[$locale,$music->id]) }}">
                                        <i class="text-success cil-image1" title="Details"></i>
                                    </a>
                                    @if($user->role < 2)
                                        <a href="{{ route('music.edit',[$locale,$music->id]) }}">
                                            <i class="text-info cil-pencil" title="Edit"></i>
                                        </a>
                                        <a href="{{ route('music.delete',[$locale,$music->id]) }}"
